...
$majesticsupport_css .= '
	...
	div.mjtc-support-search-form-btn-wrp input.mjtc-search-button{background: '.$MJTC_color1.' !important;color:'.$MJTC_color7.' !important;border:1px solid '.$MJTC_color5.';margin-right:10px;}
	...
	div.mjtc-support-table-body div.mjtc-support-data-row div.mjtc-support-table-body-col a.mjtc-support-table-action-btn {border:1px solid '.$MJTC_color5.';background: #ffff;}
	div.mjtc-support-table-body div.mjtc-support-data-row div.mjtc-support-table-body-col a.mjtc-support-table-action-btn:hover {border-color:'.$MJTC_color1.';}
	div.mjtc-support-staff-wrapper div.mjtc-support-table-body div.mjtc-support-data-row {border:1px solid'.$MJTC_color5.';}
