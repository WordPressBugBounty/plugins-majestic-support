...
$majesticsupport_css .= '
	...
	select.mjtc-support-select-field{background-color: '.$MJTC_color7.' !important;border:1px solid  '.$MJTC_color5.';color: '.$MJTC_color4.';}
	...
	div.mjtc-support-table-body div.mjtc-support-data-row div.mjtc-support-table-body-col .mjtc-support-table-action-btn {border: 1px solid '.$MJTC_color5.';background: '.$MJTC_color7.';}
