...
$majesticsupport_css .= '
	...
	div.mjtc-support-fields-wrp div.mjtc-support-form-field select.mjtc-support-field-input{background-color: #fff;border:1px solid  '.$MJTC_color5.';color: '.$MJTC_color4.';}
