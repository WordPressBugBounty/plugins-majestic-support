...
div.mjtc-support-search-form-btn-wrp input.mjtc-reset-button, div.mjtc-support-table-header {background: '.$MJTC_color2.';color: '.$MJTC_color7.';border:1px solid  '.$MJTC_color5.';}
div.mjtc-support-table-header div.mjtc-support-table-header-col {color: '.$MJTC_color7.' !important}
...
// div.mjtc-support-table-header{border:1px solid  '.$MJTC_color5.';}
...
div.mjtc-support-department-wrapper div.mjtc-support-table-body div.mjtc-support-data-row {border:1px solid'.$MJTC_color5.';}
