...
/* Downloads */
	div.mjtc-support-top-search-wrp{border:1px solid '.$MJTC_color5.';background: '.$MJTC_color3.';}
	...
	div.mjtc-support-table-header-wrp{background-color:'.$MJTC_color6.';border:1px solid '.$MJTC_color5.';}
