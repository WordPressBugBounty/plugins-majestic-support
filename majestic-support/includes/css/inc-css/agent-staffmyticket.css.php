...
/* Search Ticket Form*/
	...
	div.mjtc-support-search-wrp div.mjtc-support-form-wrp form.mjtc-filter-form div.mjtc-filter-field-wrp select#ms-productid{width: 100%;border-radius: unset;background: url('.esc_url(MJTC_PLUGIN_URL).'includes/images/selecticon.png) 96% / 4% no-repeat ;padding: 10px;line-height: initial;height: 50px;}
...
/* My Tickets */
	div.mjtc-support-top-cirlce-count-wrp {border:1px solid'.$MJTC_color5.';}
	...
	/* Search Ticket Form*/
		...
		div.mjtc-support-search-wrp div.mjtc-support-form-wrp form.mjtc-filter-form div.mjtc-filter-wrapper {background-color:'.$MJTC_color3.';}
		div.mjtc-support-search-wrp div.mjtc-support-form-wrp form.mjtc-filter-form div.mjtc-filter-wrapper div.mjtc-filter-form-fields-wrp input.mjtc-support-input-field{border:1px solid '.$MJTC_color5.';color: '.$MJTC_color4.';}
		...
		div.mjtc-support-search-wrp div.mjtc-support-form-wrp form.mjtc-filter-form div.mjtc-filter-field-wrp select#ms-departmentid{background-color:#fff;border:1px solid'.$MJTC_color5.';color: '.$MJTC_color4.';}
		div.mjtc-support-search-wrp div.mjtc-support-form-wrp form.mjtc-filter-form div.mjtc-filter-field-wrp select#ms-priorityid{background-color:#fff;border:1px solid'.$MJTC_color5.';color: '.$MJTC_color4.';}
		div.mjtc-support-search-wrp div.mjtc-support-form-wrp form.mjtc-filter-form div.mjtc-filter-field-wrp select#ms-productid{background-color:#fff;border:1px solid'.$MJTC_color5.';color: '.$MJTC_color4.';}
		div.mjtc-support-search-wrp div.mjtc-support-form-wrp form.mjtc-filter-form div.mjtc-filter-field-wrp select#ms-status{background-color:#fff;border:1px solid'.$MJTC_color5.';color: '.$MJTC_color4.';}
		div.mjtc-support-search-wrp div.mjtc-support-form-wrp form.mjtc-filter-form div.mjtc-filter-field-wrp select#staffid{background-color:#fff;border:1px solid'.$MJTC_color5.';color: '.$MJTC_color4.';}
		div.mjtc-support-search-wrp div.mjtc-support-form-wrp form.mjtc-filter-form div.mjtc-filter-field-wrp select#ms-status{background-color:#fff;border:1px solid'.$MJTC_color5.';color: '.$MJTC_color4.';}
		...
		div.mjtc-support-search-wrp div.mjtc-support-form-wrp form.mjtc-filter-form div.mjtc-filter-button-wrp .mjtc-search-filter-btn {border: 1px solid '.$MJTC_color5.';color: '.$MJTC_color4.';background: #fff;}
	...
	/* My Tickets $ Staff My Tickets*/
		...
		div.mjtc-support-wrapper div.mjtc-support-data span.mjtc-support-status{background-color:#FFFFFF;border: 1px solid '.$MJTC_color5.';}
		...
		div.mjtc-support-assigned-tome{border:1px solid'.$MJTC_color5.';background-color:#fff;color: '.$MJTC_color4.';}
