...
div.mjtc-support-add-form-wrapper div.mjtc-support-from-field-wrp div.mjtc-support-from-field select#status{background-color:#fff !important;border:1px solid '.$MJTC_color5.';color: '.$MJTC_color4.';}
div.mjtc-support-add-form-wrapper div.mjtc-support-from-field-wrp div.mjtc-support-from-field select#visible{background-color:#fff !important;border:1px solid '.$MJTC_color5.';color: '.$MJTC_color4.';}
div.mjtc-support-add-form-wrapper div.mjtc-support-from-field-wrp div.mjtc-support-from-field textarea {background-color:#fff;border:1px solid '.$MJTC_color5.';color: '.$MJTC_color4.';}
...
span.tk_attachments_addform{background-color:'.$MJTC_color2.';color:'.$MJTC_color7.';border: 1px solid '.$MJTC_color5.';}
span.tk_attachments_addform:hover {border-color:'.$MJTC_color1.';}
div.mjtc_supportattachment{background-color:#fff;border:1px solid '.$MJTC_color5.';}
div.tk_attachment_value_wrapperform{border: 1px solid '.$MJTC_color5.';background: #fff;color: '.$MJTC_color4.';}
