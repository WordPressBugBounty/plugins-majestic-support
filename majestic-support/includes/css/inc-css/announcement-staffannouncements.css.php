...
$majesticsupport_css .= '
	...
	div.mjtc-support-table-heading-wrp{background-color: '.$MJTC_color3.';color: '.$MJTC_color2.';}
	...
	div.mjtc-support-announcement-wrapper div.mjtc-support-table-body div.mjtc-support-data-row {border:1px solid'.$MJTC_color5.';}
	...
	div.mjtc-support-categories-heading-wrp{background-color:'.$MJTC_color6.';border:1px solid  '.$MJTC_color5.';}
	...
	div.mjtc-support-downloads-wrp div.mjtc-support-downloads-heading-wrp{background-color:'.$MJTC_color6.';border:1px solid  '.$MJTC_color5.';}
	div.mjtc-support-downloads-content div.mjtc-support-download-box{background-color: '.$MJTC_color3.';border:1px solid  '.$MJTC_color5.';}
