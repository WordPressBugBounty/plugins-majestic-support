...
/* Add Form */
	...
	div.mjtc-support-add-form-wrapper div.mjtc-support-from-field-wrp div.mjtc-support-from-field select#status{background-color:'.$MJTC_color7.' !important;border:1px solid '.$MJTC_color5.';}
	...
	div.mjtc-support-append-signature-wrp div.mjtc-support-signature-radio-box{border:1px solid '.$MJTC_color5.';background-color:#fff;color: '.$MJTC_color4.';}
	.majestic-support-outgoing-email-message {color: '.$MJTC_color4.';}
