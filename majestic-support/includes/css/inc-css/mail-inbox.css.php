...
$majesticsupport_css .= '
	...
	div.mjtc-support-table-heading-wrp{background-color:'.$MJTC_color4.';color:'.$MJTC_color7.';}
	div.mjtc-support-table-heading-wrp div.mjtc-support-table-heading-right a.mjtc-support-table-add-btn{background:'.$MJTC_color2.';color:'.$MJTC_color7.';}
	div.mjtc-support-table-heading-wrp div.mjtc-support-table-heading-right a.mjtc-support-table-add-btn:hover{background:rgba(125, 135, 141, 0.4);color:'.$MJTC_color7.';}
	...
	div.mjtc-support-table-body div.mjtc-support-data-row div.mjtc-support-table-body-col .mjtc-support-table-action-btn:hover {border-color: '.$MJTC_color2.';}
	...
	div.mjtc-support-download-content-wrp div.mjtc-support-table-body div.mjtc-support-data-row {border:1px solid'.$MJTC_color5.';}
