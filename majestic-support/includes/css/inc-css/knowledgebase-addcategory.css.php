...
span.mjtc-support-sub-fields{background-color:#fff !important;border:1px solid '.$MJTC_color5.';color: '.$MJTC_color4.';}
div.mjtc-support-add-form-wrapper div.mjtc-support-from-field-wrp .tk_attachments_configform {color: '.$MJTC_color4.';}
