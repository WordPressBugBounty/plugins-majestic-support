...
/* Add Form */
	...
	div.mjtc-support-add-form-wrapper div.mjtc-support-from-field-wrp div.mjtc-support-from-field select#status{background-color:#fff !important;border:1px solid '.$MJTC_color5.';}
	...
	#userpopup div.mjtc-support-table-body div.mjtc-support-data-row {border: 0;border-bottom:1px solid '.$MJTC_color5.';}
