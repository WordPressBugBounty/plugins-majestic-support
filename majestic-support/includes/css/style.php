...
/* Existing colors */
    ...
    /* ticket status */
    div.mjtc-support-checkstatus-wrp p.mjtc-support-tkentckt-centrmainwrp::after{background:$color1; }
    div.mjtc-support-checkstatus-wrp p.mjtc-support-tkentckt-centrmainwrp span.mjtc-support-tkentckt-centrwrp{color:$color2;}
    div.ms-visitor-token-message p.ms-visitor-token-message-token-number a{background:$color1;color:#fff;}
