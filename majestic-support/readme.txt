...
👉 <a href="http://demo.majesticsupport.com/" target="_blank">View Demo</a> | <a href="https://www.youtube.com/channel/UCdEoePgwPrWaxJ__eA6vLIA" target="_blank">Watch Videos</a> | <a href="https://majesticsupport.com/support/" target="_blank">Support</a> | <a href="https://majesticsupport.com/" target="_blank">Plugin Homepage</a> 
...
* [Agents](https://majesticsupport.com/product/email-piping/) - Agents assist users connected to the support system and play a crucial role in the help desk. By adding this add-on, you may add more agents and give them different permissions to make it easier for users to take action on their tickets. Additionally, agents can create, delete, close, and perform any other action given to them by the admin.

* [Agent Auto Assign](https://majesticsupport.com/product/agent-auto-assignment/) - Ticket auto-assignment is a simple but critical process in the handling and closing of help desk tickets. When auto-assign is enabled, the ticket is assigned to an appropriate agent based on the rules.

* [Multi Forms](https://majesticsupport.com/product/multiple-ticket-forms/) - By using this multi-form functionality, admins, agents, and users, as well as visitors with the necessary permissions, can create different ticket forms to accommodate various request types based on user roles.

* [Email Piping](https://majesticsupport.com/product/email-piping/) - From the comfort of an email account, create tickets or reply to them. For example, you could offer your clients a special email address like support@yourdomain.com. The emails received in this email will be converted to tickets. The add-on also contains built-in options to control how to manage responses to tickets that have been closed, unrecognized email addresses, and much more.

* [Merge Tickets](https://majesticsupport.com/product/merge-tickets/) - Hundreds of tickets have been submitted for assistance, some of which may be on the same topic and have similar questions. To provide support for each ticket with the same topic would be a waste of time. With this add-on, you can merge any of the two tickets or more with the same topic and query and provide support.

* [Private Credentials](https://majesticsupport.com/product/private-credentials/) - This feature gives your tickets an additional layer of security so that users can safely enter passwords and other sensitive credentials onto the tickets.

* [Paid Support](https://majesticsupport.com/product/paid-support/) - For using your support services, charge users. Create subscriptions based on duration, such as a monthly membership, or the number of tickets, like 10 tickets per month, or charge for each ticket.

* [Time Tracking](https://majesticsupport.com/product/time-tracking/) - Track the time spent on tickets in the most precise manner while also providing client and agent-level reporting. Keep a manual record of the time invested in each ticket response.  When the ticket is open in the agent's browser track the time with a single click, and stop the time tracking with one click once the agent has finished with the ticket.

* [Ticket Overdue](https://majesticsupport.com/product/ticket-overdue/) - An "overdue ticket" is one that has not been resolved or has not been responded to in a timely manner. By adding this add-on, you can set auto-overdue tickets, overdue by priority, and cron job overdue.

* [Export](https://majesticsupport.com/product/export-tickets/) - Exports are used to keep data on the local system. By adding this add-on, you can export any of the ticket data, like ticket detail, ticket history, etc.

* [Ticket History](https://majesticsupport.com/product/ticket-history/) - As an admin, you'd like to know everything that happened on a ticket, from when it arrived at your help desk to how an agent reacted to it and what happened next. So, with the ticket history extension, you can see a summary of all the activities that have taken place on a ticket.

* [Ticket Auto Close](https://majesticsupport.com/product/auto-close-ticket/) - Automatic ticket closure reduces your effort to close the ticket manually. By enabling the add-on, tickets will be automatically closed after a set period or pre-defined rules, as determined by the administrator. While a ticket is open, it can also be closed based on the agent's response.

* [Feedback](https://majesticsupport.com/product/feedback/) - By adding this add-on, you can get feedback from your users to enhance the quality of your services. This add-on allows you to automatically collect feedback responses that rate your agent’s performance on a ticket. This add-on sends a feedback link after a ticket is closed. The user will click on a survey link and fill out the survey form on your website.

* [Help Topic](https://majesticsupport.com/product/helptopic/) - The Help Topic is used to assist the end user in locating the desired area where they want to get instant support. By adding this add-on, you can add multiple help topics with different names to help your customers more easily.

* [Private Note](https://majesticsupport.com/product/internal-note/) - Add notes to tickets that are only visible to agents and administrators.

* [Knowledge Base](https://majesticsupport.com/product/knowledge-base/) - With this add-on, you can add several knowledge bases and group solutions into various categories to better serve users. Knowledge bases are typically used to respond to basic customer inquiries.

* [Canned Response](https://majesticsupport.com/product/canned-responses/) - Predetermined answers to typical inquiries are referred to as canned answers. Instead of constantly typing the same response or pasting it from another source, the agent can insert a premade response that is activated by keystrokes or from a drop-down menu by adding this add-on.
...
* [User Options](https://majesticsupport.com/product/user-options/) - User options allow adding Google Re-Captcha or Majestic Support Re-Captcha to the registration form. Furthermore, users can register according to the roles defined by the admin, such as subscriber, author, etc.

* [Ticket Actions](https://majesticsupport.com/product/ticket-actions/) - With the basic version, limited options are available for every ticket, like create, edit, and delete. But with the ticket action extension, you can get more options like print ticket, lock ticket, make a ticket in progress, and change the ticket priority.

* [Announcements](https://majesticsupport.com/product/announcement/) - Keep your customers updated on the latest trends. With this add-on, make unlimited announcements against various categories to explore information associated with the help desk.

* [Downloads](https://majesticsupport.com/product/downloads/) - Both the admin and agent can create unlimited downloads and attach multiple files to support their site; even more, both can also add downloads category-wise. A download can only be added by an agent with the admin's permission.

* [FAQ](https://majesticsupport.com/product/faq/) - Add unlimited FAQs to answer all the basic questions asked by users. Your agents are more productive when you have effective FAQ management.

* [Multi-Language Email Templates](https://majesticsupport.com/product/multi-language-email-templates/) - It allows you to create a language-based email template for all default email templates in the Majestic Support.

* [SMTP](https://majesticsupport.com/product/smtp/) - Emails are sent and received using the TCP/IP protocol known as SMTP (Simple Mail Transfer Protocol). The administrator can define a certain email protocol for sending and receiving emails in support tickets by adding this add-on.

* [Ban Email](https://majesticsupport.com/product/ban-email/) - The ban email function is used to prevent the user from creating new tickets. You can ban any of the user's emails with this add-on; however, he will be unable to create new tickets. 

* [Email CC](https://majesticsupport.com/product/email-cc-or-bcc/) - Would you like to email another email address? It's simple with the email's CC addon. Simply choose the action, and then add the email, to perform it. A system email will also be sent to the specified email address. An exact copy of the email will be sent to the CC recipient.

* [WooCommerce](https://majesticsupport.com/product/woocommerce/) - If you have a WooCommerce store, then integrate Majestic Support with it to offer a smooth support solution. This is a must-have bridge between your WooCommerce store and Majestic Support. This means that consumers can submit tickets to report a specific order or to express any issues they may be having with the website.

* [Admin Widgets](https://majesticsupport.com/product/admin-widgets/) - Several widgets are created inside the WordPress Admin Dashboard using the Admin Widgets add-on. Depending on your business's demands, you can develop a new layout and add or delete widgets.

* [Easy Digital Download](https://majesticsupport.com/product/easy-digital-download/) - The Easy Digital Download (EDD) add-on offers support for both EDD, the Software Licensing add-on, and the Frontend Submission add-on. By using this add-on, your EDD clients will automatically be granted permission to submit support tickets.

* [Front-End Widgets](https://majesticsupport.com/product/front-end-widgets/) - Widgets in WordPress allow you to add content and features to the widgetized areas of your theme, which are mostly the sidebar. However, these widget-ready areas can be in the header, footer, sidebar, below the content, and any other area in your theme. By adding this add-on, a widget is offering two default widgets: the "Latest Ticket" and "Email Notification" widgets.

* [Envato Validation](https://majesticsupport.com/product/envato/) - You can only allow your legitimate clients to submit tickets using the Envato Validation addon. The addon will verify Envato licenses by requesting their Envato purchase code before enabling a user to open an issue. It provides support for one product, multiple products, and pre-products.
...
* Security: Admin Capability Enforcement — Added capability checks (manage_options) to ensure only authorized users can perform sensitive administrative tasks.
* Security: Strict Input Sanitization — Integrated robust sanitization for all request parameters, including ticket IDs and module keys, to prevent injection attacks.
* Bug Fix: Fixed attachment corruption issue during "Download All" operations.
...
= 1.0.2
* Improve anonymous ticket functionality.
