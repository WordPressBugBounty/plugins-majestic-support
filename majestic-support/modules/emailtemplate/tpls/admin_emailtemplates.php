...
<div id="msadmin-wrapper">
    ...
    <div id="msadmin-data">
        ...
        <div id="msadmin-data-wrp">
            ...
            if ($showformdata || in_array('multilanguageemailtemplates', majesticsupport::$_active_addons)) {
                $class = 'mjtc-custom-email-body'; ?>
                    ...
                    <div class="mjtc-support-existing-custom-templates">
                        ...
                        if (!empty(majesticsupport::$_data[0]->multiTemplates)) { ?>
                            ...
                            <table class="mjtc-support-custom-templates-table" id="ms-import-data-result-table">
                                ...
                                <tbody>
                                    <?php
                                    foreach (majesticsupport::$_data[0]->multiTemplates as $MJTC_key => $multiTemplate) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?page=majesticsupport_emailtemplate&for=<?php echo esc_attr(majesticsupport::$_data[1]); ?>&formid=<?php echo esc_html($multiTemplate->formid); ?>&langcode=<?php echo esc_html($multiTemplate->language); ?>" class="mjtc-support-action-link mjtc-support-edit"><?php echo esc_html(__('Edit', 'majestic-support')); ?></a>
                                                <span class="mjtc-support-action-separator">|</span>
                                                <a onclick="return confirm('<?php echo esc_html(__('Are you sure you want to delete', 'majestic-support')); ?>'); " href="<?php echo esc_url(wp_nonce_url('?page=majesticsupport_emailtemplate&task=deleteformemailtemplate&action=mstask&templateid='.esc_attr($multiTemplate->template_id).'&for='.esc_attr(majesticsupport::$_data[1]).'&source='.esc_attr($multiTemplate->source),'delete-template-'.$multiTemplate->template_id));?>" class="mjtc-support-action-link mjtc-support-delete"><?php echo esc_html(__('Delete', 'majestic-support')); ?></a>
                                                <span class="mjtc-support-action-separator">|</span>
                                                <a href="?page=majesticsupport_emailtemplate&for=<?php echo esc_attr(majesticsupport::$_data[1]); ?>&formid=<?php echo esc_html($multiTemplate->formid); ?>&langcode=<?php echo esc_html($multiTemplate->language); ?>" class="mjtc-support-action-link mjtc-support-preview"><?php echo esc_html(__('Preview', 'majestic-support')); ?></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
            ...
            <form method="post" action="<?php echo esc_url(wp_nonce_url(admin_url("?page=majesticsupport_emailtemplate&task=saveemailtemplate"),"save-email-template-".$MJTC_nonce_id)); ?>">
                <div class="mjtc-email-body <?php echo esc_attr($class); ?>">
                    ...
                    if (!empty(majesticsupport::$_data[0]->language_name) || !empty(majesticsupport::$_data[0]->multiformname)) { ?>
                        <div class="mjtc-support-card-wrapper">
                            ...
                            if (!empty(majesticsupport::$_data[0]->multiformname)) { ?>
                                <div class="mjtc-support-card-item">
                                    <div class="mjtc-support-card-icon">
                                        <img alt="<?php echo esc_html(__('Configuration','majestic-support')); ?>" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/left-icons/menu/system-email.png" />
                                    </div>
                            ...
                            if (!empty(majesticsupport::$_data[0]->language_name)) { ?>
                                <div class="mjtc-support-card-item">
                                    <div class="mjtc-support-card-icon">
                                        <img alt="<?php echo esc_html(__('Configuration','majestic-support')); ?>" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/left-icons/menu/download.png" />
                                    </div>
                                    <div class="mjtc-support-card-content">
                                        <div class="mjtc-support-card-label">
                ...
                if (!empty(majesticsupport::$_data[0]->language_id)) {
                    $language_id = majesticsupport::$_data[0]->language_id;
                } else {
                    $language_id = '';
                }
                ?>
                ...
                <?php echo wp_kses(MJTC_formfield::MJTC_hidden('lang_id', $language_id), MJTC_ALLOWED_TAGS); ?>
            </form>
        </div>
    </div>
</div>
