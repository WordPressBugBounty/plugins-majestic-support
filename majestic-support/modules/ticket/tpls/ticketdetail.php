                                    ...
                                    if (isset($field_array['attachments']) && !empty(majesticsupport::$_data['ticket_attachment'])) { ?>
                                        <div class="mjtc-support-attachments-wrp">
                                            ...
                                            foreach (majesticsupport::$_data['ticket_attachment'] AS $attachment) {
                                                ...
                                                $ticketdata = '<a class="mjtc-all-download-button" target="_blank" href="' . esc_url(majesticsupport::makeUrl(array('mjsmod'=>'ticket', 'task'=>'downloadall', 'internalid'=> majesticsupport::$_data[0]->internalid, 'action'=>'mstask', 'downloadid'=>majesticsupport::$_data[0]->id , 'mspageid'=>get_the_ID()))) . '" >'. esc_html(__('Download All', 'majestic-support')) . '</a>';
                                                echo wp_kses($ticketdata, MJTC_ALLOWED_TAGS); ?>
                                            </div>
                                            <?php
                                        } ?>
                                            ...
                                            $attachmentdata .= '
                                                <div class="mjtc_supportattachment">
                                                    ...
                                                    if(MJTC_majesticsupportphplib::MJTC_strpos($type, "image") !== false) {
                                                        ...
                                                        $attachmentdata .= '<a data-gall="gallery-'. esc_attr($reply->replyid) .'" class="mjtc-download-button venobox" data-vbtype="image" title="'. esc_attr(esc_html(__('View','majestic-support'))) .'" href="'. esc_attr($path) .'"  target="_blank">
                                                        <img alt="'.esc_html(__('View Image','majestic-support')).'" src="' . esc_url(MJTC_PLUGIN_URL) . 'includes/images/ticket-detail/view.png" />
                                                            </a>';
                                                    }
                                                    $attachmentdata .= '
                        ...
                        <div class="mjtc-sprt-det-tkt-asgn-cnt">
                            ...
                            <div class="mjtc-sprt-det-info-wrp">
                                ...
                                <div class="mjtc-sprt-det-user">
                                    <div class="mjtc-sprt-det-user-image">
                                        <?php
                                        if(majesticsupport::$_config['anonymous_name_on_ticket_reply'] == 2){
