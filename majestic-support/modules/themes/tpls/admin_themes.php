            ...
            function makeColorPicker(color1, color2, color3, color4, color5, color6, color7) {
                jQuery('input#color1').iris({
                    ...
                    change: function (c_event, ui) {
                        ...
                        jQuery('div#ms-header div.ms-header-tab.active a.mjtc-cp-menu-link').css('background-color', hex);
                        jQuery('div#ms-header, div.mjtc-cp-wrapper, mjtc-support-add-form-wrapper').css('background-color', hex);
                        jQuery('.mjtc-support-top-sec-header').css('background-color', hex);
                        jQuery('input.mjtc-support-search-btn').css('background-color', hex);
                        jQuery('div.mjtc-support-data .mjtc-support-title-anchor').css('color', hex);
                    }
                });
                jQuery('input#color2').iris({
                    ...
                    change: function (c_event, ui) {
                        ...
                        jQuery('div.mjtc-support-wrapper').mouseover(function () {
                            ...
                            jQuery('div.mjtc-support-bottom-line').css('background-color', jQuery('input#color2').val());
                        }).mouseout(function () {
                        ...
                        jQuery('div.mjtc-support-sorting span.mjtc-support-sorting-link a.selected').css('background-color', jQuery('input#color2').val());
                        jQuery('div#ms-header-main-wrapper').css('background-color', jQuery('input#color2').val());
                        ...
                        jQuery('.mjtc-support-reset-btn').css('background-color', hex);
                        jQuery('div.mjtc-support-sorting').css('background-color', hex);
                        jQuery('div.mjtc-support-sorting').css('color', hex);
                        jQuery('div.mjtc-support-data span.mjtc-support-title').css('color', hex);
                        jQuery('div.mjtc-support-wrapper div.mjtc-support-data1 div.mjtc-support-data-row .mjtc-support-data-tit').css('color', hex);
                    }
                });
                jQuery('input#color3').iris({
                    ...
                    change: function (c_event, ui) {
                        ...
                        jQuery('div.mjtc-support-assigned-tome').css('background-color', hex);
                        jQuery('div.mjtc-support-search-wrp div.mjtc-support-form-wrp form.mjtc-filter-form div.mjtc-filter-wrapper').css('background-color', hex);
                    }
                });
                jQuery('input#color4').iris({
                    ...
                    change: function (c_event, ui) {
                        ...
                        jQuery('select.mjtc-support-sorting-select').css('color', hex);
                    }
                });
                ...
                jQuery('input#color6').iris({
                    ...
                    change: function (c_event, ui) {
                        ...
                        jQuery('a.mjtc-myticket-link').css('background-color', hex);
                    }
                });
                jQuery('input#color7').iris({
                    ...
                    change: function (c_event, ui) {
                        ...
                        jQuery('input#color7').css('background-color', hex);
                        jQuery('div#ms-header div.ms-header-tab.active a.mjtc-cp-menu-link').css('color', hex);
                        jQuery('div.mjtc-support-sorting span.mjtc-support-sorting-link a').css('color', hex);
                        jQuery('div#ms-header div#ms-header a').css('color', hex);
                    }
                });
            }
