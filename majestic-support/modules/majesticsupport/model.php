    ...
    function getPageTitle($layouts){
        ...
        switch ($layouts) {
            ...
            case 'downloads':
                ...
                <a target=\"blank\" href=\"https://www.youtube.com/watch?v=jrsWVyNJm54\" class=\"msadmin-video-link mjtc-cp-video-popup\" title=\"". esc_html(__('How to use downloads', 'majestic-support')) ."\">
                    <img alt=\"". esc_html(__('arrow','majestic-support')) ."\" src=\"". esc_url(MJTC_PLUGIN_URL) ."includes/images/watch-video.png\"/>
                </a>";
            ...
            case 'faqs':
                ...
                <a target=\"blank\" href=\"https://www.youtube.com/watch?v=gOgxbQjdFJg\" class=\"msadmin-video-link mjtc-cp-video-popup\" title=\"". esc_html(__('How to create FAQ', 'majestic-support')) ."\">
                    <img alt=\"". esc_html(__('arrow','majestic-support')) ."\" src=\"". esc_url(MJTC_PLUGIN_URL) ."includes/images/watch-video.png\"/>
                </a>";
            ...
            case 'emailcc':
                ...
                <a target=\"blank\" href=\"https://www.youtube.com/watch?v=bu3h7LiGry0\" class=\"msadmin-video-link mjtc-cp-video-popup\" title=\"". esc_html(__('How to use email cc', 'majestic-support')) ."\">
                    <img alt=\"". esc_html(__('arrow','majestic-support')) ."\" src=\"". esc_url(MJTC_PLUGIN_URL) ."includes/images/watch-video.png\"/>
                </a>";
