                        ...
                        case 'sec-addons': ?>
                            <div class="mjtc-cp-cnt-sec <?php echo esc_attr($MJTC_visibility_class); ?>" id="sec-addons" style="margin-bottom: 1rem; <?php echo esc_attr($MJTC_visibility_style); ?>">
                                ...
                                $MJTC_all_addons_list = [
                                    ...
                                    ['instantfix', __('Instant Fix', 'majestic-support'), __('AI-powered proactive issue resolution', 'majestic-support'), 'M13 2 3 14 12 14 11 22 21 10 12 10 13 2z', '--mjtc-admin-accent-emerald'],
