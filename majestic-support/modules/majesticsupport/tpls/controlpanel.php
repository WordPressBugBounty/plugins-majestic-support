...
if (majesticsupport::$_config['offline'] == 2) {
        ...
        <div class="mjtc-cp-main-wrp">
                            ...
                            if (majesticsupport::$_config['cplink_login_logout_user'] == 1){
                                ...
                                $loginlink = MJTC_includer::MJTC_getModel('configuration')->getConfigValue('login_link');
                                    ...
                                    if (!is_user_logged_in()):
                                        ...
                                        mjtc_printMenuLink($menu_title, $menu_url, $image_path,$MJTC_count);
                                    endif;
                                if (is_user_logged_in()):
                    ...
                    <div id="mjtc-dash-menu-link-wrp">
                        <div class="mjtc-menu-links-wrp">
                            ...
                            if (majesticsupport::$_config['cplink_roles_staff'] == 1):
                                ...
                                $menu_title =  esc_html(__('Agent Roles', 'majestic-support'));
                                mjtc_printMenuLink($menu_title, $menu_url, $image_path);
                            endif;
            ...
            <div class="mjtc-cp-right">
                ...
                <div class="mjtc-support-ticket-cont" style="display: flex">
                    ...
                    if(isset($MJTC_data['count']) && majesticsupport::$_config['cplink_totalcount_'. $linkname] == 1){
                        $open_percentage = 0;
                        $MJTC_close_percentage = 0;
                        $answered_percentage = 0;
                        $overdue_percentage = 0;
                        $allticket_percentage = 0;
                        if($MJTC_data['count']['allticket'] > 0){ //to avoid division by zero error
                            $open_percentage = round(($MJTC_data['count']['openticket'] / $MJTC_data['count']['allticket']) * 100);
                            $MJTC_close_percentage = round(($MJTC_data['count']['closedticket'] / $MJTC_data['count']['allticket']) * 100);
                            $answered_percentage = round(($MJTC_data['count']['answeredticket'] / $MJTC_data['count']['allticket']) * 100);
                            if(isset($MJTC_data['count']['overdue'])){
                                $overdue_percentage = round(($MJTC_data['count']['overdue'] / $MJTC_data['count']['allticket']) * 100);
                            }
                                        ...
                                        <div class="top-sec-left">
                                            ...
                                            if(majesticsupport::$_config['count_on_myticket'] == 1){
                                                ...
                                                if(isset($MJTC_data['count']['openticket'])){
                                                    $openticket = $MJTC_data['count']['openticket'];
                                                }
                                        ...
                                        <div class="top-sec-left">
                                            ...
                                            if(majesticsupport::$_config['count_on_myticket'] == 1){
                                                ...
                                                if(isset($MJTC_data['count']['answeredticket'])){
                                                    $answeredticket = $MJTC_data['count']['answeredticket'];
                                                }
                                        ...
                                        <div class="top-sec-left">
                                            ...
                                            if(majesticsupport::$_config['count_on_myticket'] == 1){
                                                ...
                                                if(isset($MJTC_data['count']['closedticket'])){
                                                    $closedticket = $MJTC_data['count']['closedticket'];
                                                }
                                        ...
                                        <div class="top-sec-left">
                                            <div class="top-sec-left-heading">
                                                ...
                                                if(majesticsupport::$_config['count_on_myticket'] == 1){
                                                    $overdue = 0;
                                                    if(isset($MJTC_data['count']['overdue'])){
                                                        $overdue = $MJTC_data['count']['overdue'];
                                                    }
                                        ...
                                        <div class="top-sec-left">
                                            ...
                                            if(majesticsupport::$_config['count_on_myticket'] == 1){
                                                ...
                                                if(isset($MJTC_data['count']['allticket'])){
                                                    $allticket = $MJTC_data['count']['allticket'];
                                                }
                                                ...
                                                <div class="mjtc-support-ticket-subject">
                                                    ...
                                                    if (!empty($show_on_listing_array['fullname'])) { ?>
                                                        <div class="mjtc-support-data-row">
                                                            <?php echo esc_html(majesticsupport::MJTC_getVarValue($MJTC_ticket->name)); ?>
                                                        </div>
                                                        <?php
                                                    }
                                                    if (isset($field_array['subject'])) { ?>
                                                        <div class="mjtc-support-data-row name">
                                                            <a class="mjtc-support-data-link"
                                                                    href="<?php echo esc_url(majesticsupport::makeUrl(array('mjsmod'=>'ticket','mjslay'=>'ticketdetail','majesticsupportid'=> $MJTC_ticket->id))); ?>">
                                            ...
                                            <div class="mjtc-second-support-overall-left-wrapper">
                                                <div class="mjtc-support-second-left">
                                                    ...
                                                    if ($MJTC_ticket->ticketviaemail == 1){  ?>
                                                        <span class="mjtc-support-creade-via-email-spn">
                                                            <?php echo esc_html(majesticsupport::MJTC_getVarValue($MJTC_ticketviamail)); ?>
                                                        </span>
                                                    <?php } ?>
                                                    <?php
                                                    $MJTC_counter = 'one';
                                                    if ($MJTC_ticket->lock == 1) { ?>
                                                        <img class="ticketstatusimage <?php echo esc_attr($MJTC_counter); $MJTC_counter = 'two'; ?>" src="<?php echo esc_url(MJTC_PLUGIN_URL) . "includes/images/lock.png"; ?>" title="<?php echo esc_attr(__('The ticket is locked', 'majestic-support')); ?>" />
                                                    <?php } ?>
                                                ...
                                                if (!empty($show_on_listing_array['priority'])) { ?>
                                                    <div class="mjtc-support-fourth-left">
                                                        <span class="mjtc-support-priorty" style="background:<?php echo esc_attr($MJTC_ticket->prioritycolour); ?>;">
                                ...
                                <div class="mjtc-support-row">
                                    <div class="mjtc-support-first-left">
                                        ...
                                        <div class="mjtc-support-ticket-subject">
                                            ...
                                            <div class="mjtc-support-data-row name">
                                                <a class="mjtc-support-data-link"
                                                    href="<?php echo esc_url(majesticsupport::makeUrl(array('mjsmod'=>'ticket','mjslay'=>'ticketdetail','majesticsupportid'=> $MJTC_ticket->id))); ?>"><?php echo esc_html($MJTC_ticket->subject); ?></a>
                                            </div>
                                            <?php
                                            if (!empty($show_on_listing_array['department'])) { ?>
                                                <div class="mjtc-support-data-row">
                                    ...
                                    <div class="mjtc-second-support-overall-left-wrapper">
                                       <div class="mjtc-support-second-left">
                                            <?php if ($MJTC_ticket->ticketviaemail == 1){  ?>
                                                <span class="mjtc-support-creade-via-email-spn">
                                                    <?php echo esc_html(majesticsupport::MJTC_getVarValue($MJTC_ticketviamail)); ?>
                                                </span>
                                            <?php }
            ...
            <!-- latest downloads -->
            <?php
            if(isset($MJTC_data['latest-downloads'])  && majesticsupport::$_config['cplink_latestdownloads_'. $linkname] == 1){
                ?>
                    <div class="mjtc-support-data-list-wrp latst-dnlds">
                        ...
                        <div class="mjtc-support-data-list">
                            <?php
                        $imgindex = 1;
                        foreach($MJTC_data['latest-downloads'] as $download){
                            ?>
                            <div class="mjtc-support-data">
                                <div class="mjtc-support-data-tit">
                                    ...
                                    <a onclick="getDownloadById(<?php echo esc_js($download->downloadid) ?>, '<?php echo esc_js($nonce) ?>')">
            ...
            <?php
            if(isset($MJTC_data['latest-announcements'])  && majesticsupport::$_config['cplink_latestannouncements_'. $linkname] == 1){
                ?>
                    <div class="mjtc-support-data-list-wrp latst-ancmts">
                        ...
                        <div class="mjtc-support-data-list">
                            <?php
                        $imgindex = 1;
                        foreach($MJTC_data['latest-announcements'] as $announcement){
                            ?>
                            <div class="mjtc-support-data">
            ...
            <!-- latest articles -->
            <?php
            if(isset($MJTC_data['latest-articles'])  && majesticsupport::$_config['cplink_latestkb_'. $linkname] == 1){
                ?>
                    <div class="mjtc-support-data-list-wrp latst-kb">
                        ...
                        <div class="mjtc-support-data-list">
                            <?php
                        $imgindex = 1;
                        foreach($MJTC_data['latest-articles'] as $article){
                            ?>
                            <div class="mjtc-support-data">
                                <a class="mjtc-support-data-tit"
            ...
            <!-- latest faqs -->
            <?php
            if(isset($MJTC_data['latest-faqs'])  && majesticsupport::$_config['cplink_latestfaqs_'. $linkname] == 1){
                ?>
                    <div class="mjtc-support-data-list-wrp latst-faqs">
                        ...
                        <div class="mjtc-support-data-list">
                            <?php
                        $imgindex = 1;
                        foreach($MJTC_data['latest-faqs'] as $faq){
                            ?>
                            <div class="mjtc-support-data">
    ...
    function mjtc_printMenuLink($title, $MJTC_url, $image_path, $ajaxid=""){
        $html = '
        <a class="mjtc-col-xs-12 mjtc-col-sm-6 mjtc-col-md-4 mjtc-support-dash-menu" href="'.esc_url($MJTC_url).'" '.esc_attr($ajaxid).'>
