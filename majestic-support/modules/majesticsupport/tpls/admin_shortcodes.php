					...
					<?php 
						...
						foreach ($multiforms as $multiform) {
						 	$MJTC_data = '<div class="ms-shortcode-2">
					 			...
					 			$MJTC_data .= '<span class="ms-shortcode-name">('.esc_html(majesticsupport::MJTC_getVarValue($multiform->title)).'</span>';
						 		if (isset($multiform->departmentname)) {
						 			$MJTC_data .= '<span class="ms-shortcode-dept"> - '.esc_html($multiform->departmentname).')</span>';
						 		} else {
