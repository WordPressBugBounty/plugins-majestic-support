        ...
        <div id="msadmin-data-wrp">
            <div class="msadmin-add-on-page-wrp">
                <div class="add-on-banner">
                    <img class="add-on-banner-left-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/left-image.png" alt="<?php echo esc_attr(__('left image','majestic-support')); ?>"/>
                    <img class="add-on-banner-center-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/logo.png" alt="<?php echo esc_attr(__('Logo','majestic-support')); ?>" />
                    <img class="add-on-banner-right-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/right-image.png" alt="<?php echo esc_attr(__('right image','majestic-support')); ?>" />
                </div>
                    ...
                    <div class="msadd-on-list-wrp">
                        ...
                        <div class="add-on-list">
                            <div class="add-on-item agent">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/agent.png" alt="<?php echo esc_attr(__('Agent','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item multiform">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/multiform.png" alt="<?php echo esc_attr(__('multiform','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item email-piping">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/email-piping.png" alt="<?php echo esc_attr(__('Email Piping','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item agentautoassign">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/agent-auto-assign.png" alt="<?php echo esc_attr(__('Agent Auto Assign','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item private-note">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/private-note.png" alt="<?php echo esc_attr(__('Private Note','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item merge-tkt">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/merge-tickets.png" alt="<?php echo esc_attr(__('Merge Tickets','majestic-support')); ?>"/>
                            ...
                            <div class="add-on-item help-topic">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/helptopic.png" alt="<?php echo esc_attr(__('Help Topics','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item close-tkt">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/ticket-auto-close.png" alt="<?php echo esc_attr(__('Auto Close Ticket','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item kb">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/kb.png" alt="<?php echo esc_attr(__('Knowledgebase','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item overdue-tkt">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/ticket-overdue.png" alt="<?php echo esc_attr(__('Ticket Overdue','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item time-tracking">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/time-tracking.png" alt="<?php echo esc_attr(__('Time Tracking','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item tkt-histry">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/ticket-history.png" alt="<?php echo esc_attr(__('Ticket History','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item paid-support">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/paid-support.png" alt="<?php echo esc_attr(__('Paid Support','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item email-piping">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/privatecredentials.png" alt="<?php echo esc_attr(__('Private Credentials','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item close-tkt-reason">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/close-ticket-reson.png" alt="<?php echo esc_attr(__('Ticket Close Reason','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item aipoweredreply">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/aipoweredreply.png" alt="<?php echo esc_attr(__('AI Powered Reply','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item canned-resp">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/canned-responses.png" alt="<?php echo esc_attr(__('Premade Responses','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item max-tkt">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/max-ticket.png" alt="<?php echo esc_attr(__('max ticket','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item feedback">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/feedback.png" alt="<?php echo esc_attr(__('Feedback','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item tkt-actions">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/ticket-actions.png" alt="<?php echo esc_attr(__('Ticket Actions','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item export">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/export.png" alt="<?php echo esc_attr(__('Export','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item email-cc">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/emailcc.png" alt="<?php echo esc_attr(__('Email CC','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item user-opt">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/user-options.png" alt="<?php echo esc_attr(__('User Options','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item smtp">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/smtp.png" alt="<?php echo esc_attr(__('SMTP','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item multilanguagetemplate">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/multilanguageemailtemplates.png" alt="<?php echo esc_attr(__('SMTP','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item downloads">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/downloads.png" alt="<?php echo esc_attr(__('Downloads','majestic-support')); ?>"/>
                            ...
                            <div class="add-on-item announcements">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/announcments.png" alt="<?php echo esc_attr(__('Announcements','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item ban-email">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/ban-email.png" alt="<?php echo esc_attr(__('Ban Email','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item faq">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/faq.png" alt="<?php echo esc_attr(__('FAQ','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item admin-widg">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/admin-widgets.png" alt="<?php echo esc_attr(__('Admin Widgets','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item desk-notif">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/desktop-notifications.png" alt="<?php echo esc_attr(__('desktop notifications','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item help-topic">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/woocommerce.png" alt="<?php echo esc_attr(__('WooCommerce','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item mail-chimp">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/mail-chimp.png" alt="<?php echo esc_attr(__('Mailchimp','majestic-support')); ?>" />
                                <div class="add-on-name"><?php echo esc_html(__('Mailchimp','majestic-support')); ?></div>
                            ...
                            <div class="add-on-item internal-mail">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/internal-mail.png" alt="<?php echo esc_attr(__('Internal Mail','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item fe-widget">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/frontend-widget.png" alt="<?php echo esc_attr(__('frontend widget','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item envato">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/envato.png" alt="<?php echo esc_attr(__('envato','majestic-support')); ?>" />
                            ...
                            <div class="add-on-item easy-digi-dwnlds">
                                <img class="add-on-img" src="<?php echo esc_url(MJTC_PLUGIN_URL); ?>includes/images/add-on-list/easy-digital-downloads.png" alt="<?php echo esc_attr(__('easy digital download','majestic-support')); ?>" />
                    ...
                    <div class="add-on-bundle-pack-list">
                        <div class="add-on-bundle-pack-item basic">
                            ...
                            <ul class="add-on-bundle-pack-feat">
                                ...
                                <li><?php echo esc_html(__('Help Topics','majestic-support')); ?></li>
