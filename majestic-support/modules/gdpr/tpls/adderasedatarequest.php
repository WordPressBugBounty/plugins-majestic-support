    ...
    <div class="mjtc-support-cont-main-wrapper">
        ...
        <?php if (MJTC_includer::MJTC_getObjectClass('user')->MJTC_uid() != 0) { ?>
            <div class="mjtc-support-add-form-main-wrapper">
                <div class="mjtc-support-top-search-wrp">
                    <div class="mjtc-support-search-heading-wrp">
                        ...
                        <div class="mjtc-support-heading-right">
                            ...
                            <a class="mjtc-support-add-download-btn" href="<?php echo esc_url(wp_nonce_url(majesticsupport::makeUrl(array('mjsmod'=>'gdpr','task'=>'exportusereraserequest','action'=>'mstask' ,'mspageid'=>get_the_ID())),'export-usereraserequest-'.MJTC_includer::MJTC_getObjectClass('user')->MJTC_uid())); ?>"><span class="mjtc-support-add-img-wrp"></span><?php echo esc_html(__('Export', 'majestic-support')) ?></a>
                        </div>
                    </div>
                </div>
                ...
                ?>
                <form class="mjtc-support-form" method="post" action="<?php echo esc_url(wp_nonce_url(majesticsupport::makeUrl(array('mjsmod'=>'gdpr', 'task'=>'saveusereraserequest')),"save-usereraserequest-".$MJTC_nonce_id)); ?>">
                    <div class="mjtc-support-from-field-wrp mjtc-support-from-field-wrp-full-width">
                        ...
                        <div class="mjtc-support-from-field">
                            <?php
                                ...
                                echo wp_kses(MJTC_formfield::MJTC_text('subject', $MJTC_subject, array('class' => 'inputbox mjtc-support-form-field-input', 'data-validation' => 'required')), MJTC_ALLOWED_TAGS);
                            ?>
                        </div>
                    </div>
                    <div class="mjtc-support-from-field-wrp mjtc-support-from-field-wrp-full-width">
